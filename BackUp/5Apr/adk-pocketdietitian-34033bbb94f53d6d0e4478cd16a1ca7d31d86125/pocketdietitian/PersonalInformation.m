...
-(IBAction)btnDropdownClicked:(id)sender
{
    ...
    switch (btn.tag)
    {
        ...
        case 2:
        {
            ...
            if ([txtHeightFoot.text isEqualToString:@"" ] || [txtHeightInch.text isEqualToString:@"" ] || [txtWeight.text isEqualToString:@"" ] || [txtAge.text isEqualToString:@""] || [txtGender.text isEqualToString:@""] || [txtActivityLevel.text isEqualToString:@""])
            {
                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Warning" message:@"All Field Required" delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
